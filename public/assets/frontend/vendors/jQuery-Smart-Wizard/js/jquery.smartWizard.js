...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        previous: $("<a>" + options.labelPrevious + "</a>")
            .attr("href", "#")
            .addClass("buttonPrevious"),
        finish: $("<a>" + options.labelFinish + "</a>")
            .attr("href", "#")
    ...
    var _showStep = function ($this, stepIdx) {
        ...
        if ($this.options.transitionEffect == "slide") {
            ...
            _step($this, selStep)
                .css("left", nextElmLeft1)
                .show()
                .animate({ left: nextElmLeft2 }, "fast", function (e) {
                    _setupStep($this, curStep, selStep);
                });
        } else {
    ...
    var _adjustButton = function ($this) {
        ...
        // Finish Button
        if (
            !$this.steps.hasClass("disabled") ||
            $this.options.enableFinishButton
        ) {
        ...
        var allObjs = this.each(function () {
            ...
            if (typeof method == "object" || !method || !wiz) {
                ...
                if (typeof SmartWizard.prototype[method] == "function") {
                    rv = SmartWizard.prototype[method].apply(
                        wiz,
