...
!(function (t) {
        ...
        a(e),
            e.each(function (n, i) {
                var a = n === e.length - 1 ? s : r,
                    d = t(i).outerHeight(!0);
                d < a
                    ? (o.push(i), l.push(d), u.push(t(i).height()))
                    : (c += d);
            }),
            i &&
                ((n -= c),
    ...
    function g(t, e) {
        var n = t.offset(),
            i =
                n.left +
                y(t, "border-left-width") +
                y(t, "padding-left") -
                (e ? e.left : 0),
            r =
                n.top +
                y(t, "border-top-width") +
                y(t, "padding-top") -
                (e ? e.top : 0);
        return {
            left: i,
    ...
    function p(t) {
        ...
        return (
            v() && "rtl" == t.css("direction") ? (n.left = e) : (n.right = e), n
        );
    }
    function v() {
    ...
    function C(t) {
        return (
            ...
            (window.addEventListener("scroll", t, !0), !0)
        );
    }
    function H(t) {
        return (
            !!window.removeEventListener &&
            (window.removeEventListener("scroll", t, !0), !0)
        );
    }
    function R(t, e) {
        var n = {
    ...
    function _(t, e) {
        ...
        return W(t) || W(e)
            ...
            : ((n = t.asMonths()),
              (i = e.asMonths()),
              Math.abs(n) >= 1 && ot(n) && Math.abs(i) >= 1 && ot(i)
                  ? n / i
                  : t.asDays() / e.asDays());
    }
    function Y(t, n) {
        ...
        return W(t)
            ...
            : ((i = t.asMonths()),
              Math.abs(i) >= 1 && ot(i)
                  ? e.duration({ months: i * n })
                  : e.duration({ days: t.asDays() * n }));
    }
    function W(t) {
        return Boolean(
    ...
    function at(t, e, n) {
        var i,
            ...
            a = function () {
                ...
                u < e
                    ? (i = setTimeout(a, e - u))
                    : ((i = null), n || ((l = t.apply(s, r)), (s = r = null)));
            };
        return function () {
        ...
        return (
            e.isMoment(u) || U(u) || void 0 === u
                ...
                : ((s = !1),
                  ...
                  s
                      ? ((a._ambigTime = !0), (a._ambigZone = !0))
                      : r && (o ? (a._ambigZone = !0) : c && a.utcOffset(u))),
            (a._fullCalendar = !0),
            a
        );
    }
    ...
    function pt(t, e, n, i, r) {
        var s,
            ...
            g = "",
            p = "";
        for (o = 0; o < n.length && ((s = vt(t, e, u, c, n[o])), s !== !1); o++)
            d += s;
        for (
            l = n.length - 1;
            l > o && ((s = vt(t, e, u, c, n[l])), s !== !1);
            l--
        )
            h = s + h;
    ...
    function vt(t, e, n, i, r) {
        ...
        return "string" == typeof r
            ? r
            : !!(
                  (s = r.token) && ((o = oe[s.charAt(0)]), o && n.isSame(i, o))
              ) && ct(t, s);
    }
    function mt(t) {
    ...
    function bt(e) {
        ...
        if (
            ...
            i.then = function (t, e) {
                ...
                } else if ("rejected" === n && "function" == typeof e)
                    return e(), i;
                return r.call(i, t, e);
            };
        }
    ...
    function Tt(t, e) {
        return (
            (!t && !e) ||
            (!(!t || !e) && t.component === e.component && Ct(t, e) && Ct(e, t))
        );
    }
    function Ct(t, e) {
        for (var n in t)
    ...
    function Bt(t, e) {
        ...
        for (n = 0; n < e.length; n++)
            if (
                ((i = e[n]), i.leftCol <= t.rightCol && i.rightCol >= t.leftCol)
            )
                return !0;
        return !1;
    }
    ...
    function Gt(t) {
        ...
        if (void 0 === t.forwardPressure) {
            for (e = 0; e < i.length; e++)
                (n = i[e]), Gt(n), (r = Math.max(r, 1 + n.forwardPressure));
            t.forwardPressure = r;
        }
    }
    function Ot(t, e, n) {
    ...
    function Pt(e, n) {
                            ...
                            "title" == i
                                ...
                                : ((r = (e.options.customButtons || {})[i])
                                  ...
                                  a &&
                                      ((d = r
                                          ? r.themeIcon
                                          : e.options.themeButtonIcons[i]),
                                      (h = r
                                          ? r.icon
                                          : e.options.buttonIcons[i]),
                                      (f = u
                                          ? tt(u)
                                          : d && e.options.theme
        ...
        function u(t) {
            g &&
                g.find(".fc-" + t + "-button").removeClass(p + "-state-active");
        }
        function c(t) {
            g &&
                g
    ...
    function _t(n, i) {
        ...
        function o() {
            n.addClass("fc"),
                n.on("click.fc", "a[data-goto]", function (e) {
                    ...
                    "function" == typeof o
                        ? o(r, e)
                        : ("string" == typeof o && (s = o), B(r, s));
                }),
                _.bindOption("theme", function (t) {
                    ($ = t ? "ui" : "fc"),
                        n.toggleClass("ui-widget", t),
                        n.toggleClass("fc-unthemed", !t);
                }),
                _.bindOptions(["isRTL", "locale"], function (t) {
                    n.toggleClass("fc-ltr", !t), n.toggleClass("fc-rtl", t);
                }),
                (q = t("<div class='fc-view-container'/>").prependTo(n));
            var e = y();
            (W = new Vt(e)),
                (U = _.header = e[0]),
                (j = _.footer = e[1]),
                ...
                _.options.handleWindowResize &&
                    ((K = at(v, _.options.windowResizeDelay)),
                    t(window).resize(K));
        }
        function l() {
            Q && Q.removeElement(),
        ...
        function u(e, n) {
            ...
            i && (F(), c()),
                !Q &&
                    ...
                    Q.setElement(
                        t("<div class='fc-view fc-" + e + "-view' />").appendTo(
                            q
                        )
                    ),
        ...
        function c() {
            W.proxyCall("deactivateButton", Q.type),
                Q.removeElement(),
                (Q = _.view = null);
        }
        function d() {
        ...
        function g() {
            ...
            X =
                "number" == typeof t
                    ...
                    ? n.parent().height() - p()
                    : Math.round(
                          q.width() / Math.max(_.options.aspectRatio, 0.5)
                      );
        }
        function p() {
        ...
        function v(t) {
            !nt &&
                ...
                Q.start &&
                h(!0) &&
                Q.publiclyTrigger("windowResize", tt);
        }
        function m() {
        ...
        function S() {
            return {
                ...
                layout: _.options.header,
            };
        }
        function w() {
            return {
                extraClasses: "fc-footer-toolbar",
                layout: _.options.footer,
            };
        }
        function E() {
        ...
        function D() {
            var t = _.getNow();
            t >= Q.intervalStart && t < Q.intervalEnd
                ? W.proxyCall("disableButton", "today")
                : W.proxyCall("enableButton", "today");
        }
        function T(t, e) {
        ...
        function B(t, e) {
            var n;
            (e = e || "day"),
                (n = _.getViewSpec(e) || _.getUnitViewSpec(e)),
                (J = t.clone()),
                u(n ? n.type : null);
        }
        function z() {
        ...
        function V(t) {
            ...
            if (1 === n) {
                ...
                if ("businessHours" === e)
                    return void (
                        Q &&
                        (Q.unrenderBusinessHours(), Q.renderBusinessHours())
                    );
                if ("timezone" === e)
                    return _.rezoneArrayEventSources(), void _.refetchEvents();
            }
            E(), b(), (et = {}), d();
        }
        function P(t, e) {
            var n = Array.prototype.slice.call(arguments, 2);
            if (((e = e || tt), this.triggerWith(t, e, n), _.options[t]))
                return _.options[t].apply(e, n);
        }
        var _ = this;
        (_.render = s),
            (_.destroy = l),
        ...
        _.bindOptions(
            ...
            function (t, e, n, i, s, o, l) {
                ...
                ("ISO" !== l && "local" !== l && "function" != typeof l) ||
                    (Y._fullCalendar_weekCalc = l),
                    J && r(J);
            }
        ),
            (_.defaultAllDayEventDuration = e.duration(
                _.options.defaultAllDayEventDuration
            )),
            (_.defaultTimedEventDuration = e.duration(
                _.options.defaultTimedEventDuration
            )),
            (_.moment = function () {
                var t;
                return (
            ...
            (_.getNow = function () {
                var t = _.options.now;
                return (
                    "function" == typeof t && (t = t()), _.moment(t).stripZone()
                );
            }),
            (_.getEventEnd = function (t) {
                return t.end
                    ? t.end.clone()
                    : _.getDefaultEventEnd(t.allDay, t.start);
            }),
            (_.getDefaultEventEnd = function (t, e) {
                var n = e.clone();
                return (
                    t
                        ? n.stripTime().add(_.defaultAllDayEventDuration)
                        : n.add(_.defaultTimedEventDuration),
        ...
        var W,
            ...
            nt = 0;
        (J =
            null != _.options.defaultDate
                ? _.moment(_.options.defaultDate).stripZone()
                : _.getNow()),
            ...
            (_.isHeightAuto = function () {
                return (
                    "auto" === _.options.contentHeight ||
                    "auto" === _.options.height
                );
            }),
    ...
    function Ut() {
        ...
        function r(t) {
            ...
            for (e = 0; e < t.length; e++)
                (n = t[e]),
                    n.start.clone().stripZone() < Z &&
                        U.getEventEnd(n).stripZone() > q &&
                        i.push(n);
            return i;
        }
        function s(t, e) {
        ...
        function u(t, e) {
            var n, i;
            for (
                "reset" === e ? (nt = []) : "add" !== e && (nt = C(nt, t)),
                    n = 0;
                n < t.length;
                n++
            )
                (i = t[n]),
                    "pending" !== i._status && et++,
        ...
        function R(t) {
            ...
            for (e = 0; e < t.length; e++)
                (n = t[e]),
                    ...
                    n.end ? (n.end = U.moment(n.end)) : (n.end = null),
                    Y(n, x(n));
            i();
        }
        function x(e) {
        ...
        function M(e) {
            ...
            for (
                ...
                t.isArray(tt[r].events) &&
                    (tt[r].events = t.grep(tt[r].events, e, !0));
            i();
        }
        function B(e) {
        ...
        function z(t) {
            (t.start = U.moment(t.start)),
                t.end && (t.end = U.moment(t.end)),
                jt(t);
        }
        function F(n, i) {
            var r,
                ...
                l = {};
            if (
                (U.options.eventDataTransform &&
                    (n = U.options.eventDataTransform(n)),
                ...
                (l.start = r ? e.duration(r) : null),
                    (l.end = s ? e.duration(s) : null),
                    (l._recurring = !0);
            else {
                ...
                s && ((s = U.moment(s)), s.isValid() || (s = null)),
                    ...
                    void 0 === o &&
                        (o = J(
                            i ? i.allDayDefault : void 0,
                            U.options.allDayDefault
                        )),
                    A(r, s, o, l);
            }
        ...
        function V(t) {
            P(t),
                ...
                t.end ||
                    (U.options.forceEventDuration
                        ? (t.end = U.getDefaultEventEnd(t.allDay, t.start))
                        : (t.end = null));
        }
        function P(t) {
            null == t.allDay &&
                ...
                t.allDay
                    ...
                    : (t.start.hasTime() ||
                          (t.start = U.applyTimezone(t.start.time(0))),
                      t.end &&
                          !t.end.hasTime() &&
                          (t.end = U.applyTimezone(t.end.time(0))));
        }
        function _(e, n, i) {
            var r,
                s,
            ...
            return (
                ...
                (s = {
                    start: e._start.clone(),
                        ...
                        ? e._end.clone()
                        : U.getDefaultEventEnd(e._allDay, e._start),
                    allDay: n.allDay,
                }),
                V(s),
                ...
                (l = r(n.start, s.start)),
                n.end
                    ? ((a = r(n.end, s.end)), (u = a.subtract(l)))
                    : (u = null),
                ...
                t.each(e, function (e, u) {
                    ...
                    (c = {
                        ...
                        n
                            ...
                            : s &&
                              !d.end &&
                              (d.end = U.getDefaultEventEnd(d.allDay, d.start)),
                        r && (d.start.add(r), d.end && d.end.add(r)),
                        s && d.end.add(s),
                        l &&
                            !d.allDay &&
                            (r || s) &&
                            (d.start.stripZone(), d.end && d.end.stripZone()),
                        t.extend(u, o, d),
                        jt(u),
                        a.push(function () {
                            t.extend(u, c), jt(u);
        ...
        var q,
            ...
            nt = [];
        t.each(
            (U.options.events ? [U.options.events] : []).concat(
                U.options.eventSources || []
            ),
            function (t, e) {
                var n = p(e);
                n && tt.push(n);
            ...
            this.each(function (r, s) {
                ...
                "string" == typeof e
                    ? a &&
                      ...
                      ((o = a[e].apply(a, n)),
                      r || (i = o),
                      "destroy" === e && l.removeData("fullCalendar"))
                    : a ||
                      ((a = new De(l, e)),
                      l.data("fullCalendar", a),
                      a.render());
            }),
            i
        );
    ...
    re.push("_fullCalendar"),
        ...
        (ne.local = function (t) {
            return (
                ie.local.call(this, this._ambigZone || t),
                (this._ambigTime = !1),
                (this._ambigZone = !1),
                this
            );
        ...
        (ne.utcOffset = function (t) {
            return (
                ...
                ie.utcOffset.apply(this, arguments)
            );
        }),
        (ne.format = function () {
    ...
    var ue = (qt.EmitterMixin = {
                ...
                n = {
                    ...
                    listenTo: function (e, n, i) {
                        if ("object" == typeof n)
                            for (var r in n)
                                n.hasOwnProperty(r) &&
                                    this.listenTo(e, r, n[r]);
                        else
                            "string" == typeof n &&
                                e.on(
                                    n + "." + this.getListenerNamespace(),
                                    t.proxy(i, this)
                                );
                    },
                    ...
                    getListenerNamespace: function () {
                        return (
                            null == this.listenerId && (this.listenerId = e++),
        ...
        de = {
            ...
            initMouseIgnoring: function (t) {
                this.delayUnignoreMouse = at(
                    lt(this, "unignoreMouse"),
                    t || 1e3
                );
            },
            ...
            position: function () {
                ...
                (r = o.top || 0),
                    ...
                    h.is(window) || h.is(document)
                        ? ((h = c), (e = 0), (n = 0))
                        : ((i = h.offset()), (e = i.top), (n = i.left)),
                    (e += c.scrollTop()),
                    (n += c.scrollLeft()),
                    o.viewportConstrain !== !1 &&
                        ((r = Math.min(
                            r,
                            e + h.outerHeight() - u - this.margin
                        )),
        ...
        fe = (qt.CoordCache = St.extend({
            ...
            constructor: function (e) {
                (this.els = t(e.els)),
                    ...
                    (this.forcedOffsetParentEl = e.offsetParent
                        ? t(e.offsetParent)
                        : null);
            },
            build: function () {
            ...
            queryBoundingRect: function () {
                ...
                return this.els.length > 0 &&
                    ((t = d(this.els.eq(0))), !t.is(document))
                    ? f(t)
                    : null;
            },
        ...
        ge = (qt.DragListener = St.extend(ce, de, {
            ...
            constructor: function (t) {
                (this.options = t || {}),
                    (this.handleTouchScrollProxy = lt(
                        this,
                        "handleTouchScroll"
                    )),
            ...
            handleMove: function (t) {
                ...
                this.isDistanceSurpassed ||
                    ((e = n * n + i * i),
                    e >= r * r && this.handleDistanceSurpassed(t)),
    ...
    ge.mixin({
            ...
            (this.isAutoScroll =
                ...
                this.isAutoScroll &&
                    this.listenTo(
                        t,
                        "scroll",
                        at(this.handleDebouncedScroll, 100)
                    );
        },
        ...
        updateAutoScroll: function (t) {
            ...
            o &&
                ...
                i >= 0 && i <= 1
                    ? (a = i * this.scrollSpeed * -1)
                    : r >= 0 && r <= 1 && (a = r * this.scrollSpeed)),
    ...
    var pe = ge.extend({
                    ...
                    t
                        ? ((n = { left: w(t), top: E(t) }),
                          ...
                          r &&
                              ...
                              (this.origHit && (e = R(this.origHit, e) || e),
                              (i = I(e))),
            ...
            handleDragStart: function (t) {
                var e;
                ge.prototype.handleDragStart.apply(this, arguments),
                    (e = this.queryHit(w(t), E(t))),
            ...
            handleDragEnd: function () {
                this.handleHitDone(),
                    ge.prototype.handleDragEnd.apply(this, arguments);
            },
            ...
            handleInteractionEnd: function () {
                ge.prototype.handleInteractionEnd.apply(this, arguments),
                    (this.origHit = null),
                    (this.hit = null),
                    this.component.releaseHits();
            },
            handleScrollEnd: function () {
                ge.prototype.handleScrollEnd.apply(this, arguments),
                    this.computeCoords();
            },
        ...
        ve = St.extend(ce, {
            ...
            handleMove: function (t) {
                (this.topDelta = E(t) - this.y0),
                    (this.leftDelta = w(t) - this.x0),
                    this.isHidden || this.updatePosition();
            },
            hide: function () {
                this.isHidden ||
        ...
        me = (qt.Grid = St.extend(ce, de, {
            ...
            dayMousedown: function (t) {
                this.isIgnoringMouse ||
                    this.dayDragListener.startInteraction(t, {});
            },
            ...
            computeSelection: function (t, e) {
                ...
                return (
                    !(n && !this.view.calendar.isSelectionSpanAllowed(n)) && n
                );
            },
                ...
                if (n.length) {
                    ...
                    t(o).each(function (e, i) {
                        ...
                        s && (a = s.call(r, o, a)),
                            a &&
                                ((a = t(a)),
                                a.is(r.fillSegTag) && ((o.el = a), l.push(o)));
                    });
                }
                return l;
            },
            ...
            getDayClasses: function (t, e) {
                var n = this.view,
                    ...
                    r = ["fc-" + Xt[t.day()]];
                return (
                    1 == n.intervalDuration.as("months") &&
                        t.month() != n.intervalStart.month() &&
                        r.push("fc-other-month"),
                    t.isSame(i, "day")
                        ? (r.push("fc-today"),
                          e !== !0 && r.push(n.highlightStateClass))
                        : t < i
                        ? r.push("fc-past")
                        : r.push("fc-future"),
                    r
    ...
    me.mixin({
        ...
        renderEvents: function (t) {
            ...
            this.segs = [].concat(
                this.renderBgEvents(n),
                this.renderFgEvents(i)
            );
        },
        ...
        handleSegClick: function (t, e) {
            var n = this.view.publiclyTrigger(
                "eventClick",
                t.el[0],
                t.event,
                e
        ...
        handleSegMouseover: function (t, e) {
            this.isIgnoringMouse ||
                ...
                this.view.isEventResizable(t.event) &&
        ...
        handleSegMousedown: function (t, e) {
            ...
            !n &&
                this.view.isEventDraggable(t.event) &&
                this.buildSegDragListener(t).startInteraction(e, {
                    distance: 5,
                });
        },
        handleSegTouchStart: function (t, e) {
            ...
            o && a && (u = this.startSegResize(t, e)),
                u ||
                    ...
                    (n = l
                        ? this.buildSegDragListener(t)
                        : this.buildSegSelectListener(t)),
        ...
        startSegResize: function (e, n, i) {
            return (
                !!t(n.target).is(".fc-resizer") &&
                (this.buildSegResizeListener(
                    e,
                    t(n.target).is(".fc-start-resizer")
                ).startInteraction(n, i),
                !0)
            );
        },
        buildSegDragListener: function (t) {
            ...
            var d = (this.segDragListener = new pe(l, {
                ...
                hitOver: function (e, o, u) {
                    var h;
                    t.hit && (u = t.hit),
                        (i = r.computeEventDrop(
                            u.component.getHitSpan(u),
                            e.component.getHitSpan(e),
                            c
                        )),
                        i &&
                            !a.isEventSpanAllowed(r.eventToSpan(i), c) &&
                            (s(), (i = null)),
                        i && (h = l.renderDrag(i, t))
                            ? (h.addClass("fc-dragging"),
                              d.isTouch || r.applyDragOpacity(h),
                              n.hide())
                            : n.show(),
                        o && (i = null);
                },
                ...
                interactionEnd: function (s) {
                    delete t.component,
                        n.stop(!i, function () {
                            e && (l.unrenderDrag(), r.segDragStop(t, s)),
                                i
                                    ? l.reportEventDrop(c, i, r.largeUnit, u, s)
                                    : l.showEvent(c);
                        }),
        ...
        externalDragStart: function (e, n) {
            ...
            s.opt("droppable") &&
                ...
                (t.isFunction(r) ? r.call(i[0], i) : i.is(r)) &&
                    (this.isDraggingExternal ||
                        this.listenToExternalDrag(i, e, n)));
        },
        listenToExternalDrag: function (t, e, n) {
            var i,
                ...
                u = (r.externalDragListener = new pe(this, {
                    ...
                    hitOver: function (t) {
                        (i = r.computeExternalDrop(
                            t.component.getHitSpan(t),
                            a
                        )),
                            i &&
                                !l.isExternalSpanAllowed(
                                    r.eventToSpan(i),
                                    i,
                                    a.eventProps
                                ) &&
                    ...
                    interactionEnd: function (e) {
                        i && r.view.reportExternalDrop(a, i, t, e, n),
                            (r.isDraggingExternal = !1),
                            (r.externalDragListener = null);
                    },
                }));
            u.startDrag(e);
        },
        computeExternalDrop: function (t, e) {
            ...
            return (
                e.startTime && !i.start.hasTime() && i.start.time(e.startTime),
                e.duration && (i.end = i.start.clone().add(e.duration)),
                i
            );
        },
                ...
                h = (this.segResizeListener = new pe(this, {
                    ...
                    hitOver: function (n, o, u) {
                        var h = r.getHitSpan(u),
                            f = r.getHitSpan(n);
                        (i = e
                            ? r.computeEventStartResize(h, f, c)
                            : r.computeEventEndResize(h, f, c)),
                            i &&
                                (a.isEventSpanAllowed(r.eventToSpan(i), c)
                                    ? i.start.isSame(
                                          c.start.clone().stripZone()
                                      ) &&
                                      i.end.isSame(d.clone().stripZone()) &&
                                      (i = null)
                                    : (s(), (i = null))),
                    ...
                    interactionEnd: function (e) {
                        n && r.segResizeStop(t, e),
                            i
                                ? l.reportEventResize(c, i, r.largeUnit, u, e)
                                : l.showEvent(c),
        ...
        computeEventResize: function (t, e, n, i) {
            ...
            return (
                ...
                r.start.isBefore(r.end) ||
                    ...
                    "start" == t
                        ? (r.start = r.end.clone().subtract(s))
        ...
        getSegClasses: function (t, e, n) {
            var i = this.view,
                ...
                ].concat(this.getSegCustomClasses(t));
            return (
                e && r.push("fc-draggable"),
                n && r.push("fc-resizable"),
                i.isEventSelected(t.event) && r.push("fc-selected"),
                r
            );
        },
        ...
        getSegBackgroundColor: function (t) {
            return (
                t.event.backgroundColor ||
                t.event.color ||
                this.getSegDefaultBackgroundColor(t)
            );
        },
        ...
        getSegBorderColor: function (t) {
            return (
                t.event.borderColor ||
                t.event.color ||
                this.getSegDefaultBorderColor(t)
            );
        },
        ...
        eventsToSegs: function (e, n) {
            ...
            return (
                t.each(r, function (t, e) {
                    ...
                    if (xt(e[0]))
                        for (o = i.invertRanges(o), r = 0; r < o.length; r++)
        ...
        eventToRange: function (t) {
            ...
            return (
                e.localizeMoment(n), e.localizeMoment(i), { start: n, end: i }
            );
        },
        ...
        invertRanges: function (t) {
            ...
            for (t.sort(Lt), e = 0; e < t.length; e++)
                (n = t[e]),
                    n.start > l && o.push({ start: l, end: n.start }),
                    (l = n.end);
    ...
    var ye = (qt.DayTableMixin = {
            ...
            updateDayTable: function () {
                for (
                    ...
                    i.isHiddenDay(r)
                        ? o.push(s + 0.5)
                        : (s++, o.push(s), l.push(r.clone())),
                        r.add(1, "days");
                if (this.breakOnWeeks) {
                    for (
                        e = l[0].day(), t = 1;
                        t < l.length && l[t].day() != e;
                        t++
                    );
            ...
            renderHeadDateCellHtml: function (t, e, n) {
                ...
                return (
                    1 === this.rowCnt
                        ? (r = r.concat(this.getDayClasses(t, !0)))
                        : r.push("fc-" + Xt[t.day()]),
                    '<th class="' +
                        r.join(" ") +
                        '"' +
                        ...
                        i.buildGotoAnchorHtml(
                            ...
                            tt(t.format(this.colHeadFormat))
                        ) +
                        "</th>"
                );
            },
        ...
        Se = (qt.DayGrid = me.extend(ye, {
            ...
            renderDates: function (t) {
                ...
                for (
                    this.el.html(o),
                        ...
                        this.rowCoordCache = new fe({
                            els: this.rowEls,
                            isVertical: !0,
                        }),
                        this.colCoordCache = new fe({
            ...
            renderNumberCellHtml: function (t) {
                ...
                return this.view.dayNumbersVisible ||
                    ...
                    ? ((e = this.getDayClasses(t)),
                      ...
                      this.view.cellWeekNumbersVisible &&
                          t.day() == n &&
                          (i += this.view.buildGotoAnchorHtml(
                              { date: t, type: "week" },
            ...
            spanToSegs: function (t) {
                ...
                for (e = 0; e < i.length; e++)
                    (n = i[e]),
                        this.isRTL
                            ? ((n.leftCol =
                                  this.daysPerRow - 1 - n.lastRowDayIndex),
                              (n.rightCol =
                                  this.daysPerRow - 1 - n.firstRowDayIndex))
            ...
            renderFill: function (e, n, i) {
                ...
                for (n = this.renderFillSegEls(e, n), r = 0; r < n.length; r++)
                    (s = n[r]),
                        (o = this.renderFillRow(e, s, i)),
                        this.rowEls.eq(s.row).append(o),
                        l.push(o[0]);
    ...
    Se.mixin({
        ...
        getEventSegs: function () {
            return me.prototype.getEventSegs
                .call(this)
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                ...
                t.isStart &&
                    ((n = this.getEventTimeText(s)),
                    n && (d = '<span class="fc-time">' + tt(n) + "</span>")),
                (i =
                    '<span class="fc-title">' +
                    (tt(s.title || "") || "&nbsp;") +
                    "</span>"),
                ...
                for (; o < e; )
                    (c = (m[r - 1] || [])[o]),
                        c
                            ? c.attr(
                                  "rowspan",
                                  parseInt(c.attr("rowspan") || 1, 10) + 1
                              )
                            : ((c = t("<td/>")), l.append(c)),
                        (v[r][o] = c),
                        (m[r][o] = c),
        ...
        Se.mixin({
            ...
            computeRowLevelLimit: function (e) {
                ...
                for (i = 0; i < a.length; i++)
                    if (
                        ((r = a.eq(i).removeClass("fc-limited")),
                        (s = 0),
                        r.find("> td > :first-child").each(n),
                        r.position().top + s > l)
                    )
                        return i;
                return !1;
            ...
            limitRow: function (e, n) {
                ...
                if (n && n < w.segLevels.length) {
                    for (
                        ...
                        for (
                            a = r[l], i(a.leftCol), d = [], c = 0;
                            b <= a.rightCol;

                        )
                            (u = this.getCellSegs(e, b, n)),
                                d.push(u),
                                (c += u.length),
                                b++;
                        if (c) {
                            for (
                                ...
                                (v = t('<td class="fc-more-cell"/>').attr(
                                    "rowspan",
                                    f
                                )),
                                    (u = d[p]),
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function (o) {
                        ...
                        "function" == typeof l &&
                            ...
                            "popover" === l
                                ? r.showSegPopover(e, n, u, h)
                                : "string" == typeof l &&
                                  s.calendar.zoomTo(a, l);
                    });
            },
            showSegPopover: function (t, e, n, i) {
                ...
                (r = 1 == this.rowCnt ? l.el : this.rowEls.eq(t)),
                    ...
                    this.isRTL
                        ? (s.right = a.offset().left + a.outerWidth() + 1)
                        : (s.left = a.offset().left - 1),
            ...
            renderSegPopoverContent: function (e, n, i) {
                var r,
                    s = this.view,
                    o = s.opt("theme"),
                    l = this.getCellDate(e, n).format(
                        s.opt("dayPopoverFormat")
                    ),
                    a = t(
                        '<div class="fc-header ' +
                            s.widgetHeaderClass +
                ...
                for (
                    i = this.renderFgSegEls(i, !0), this.popoverSegs = i, r = 0;
                    r < i.length;
                    r++
                )
                    this.prepareHits(),
                        (i[r].hit = this.getCellHit(e, n)),
                        this.releaseHits(),
                        u.append(i[r].el);
                return a;
            },
            ...
            getCellSegs: function (t, e, n) {
                for (
                    var i, r = this.rowStructs[t].segMatrix, s = n || 0, o = [];
                    s < r.length;
    ...
    var we = (qt.TimeGrid = me.extend(ye, {
        ...
        processOptions: function () {
            ...
            (r = e.duration(r)),
                ...
                (this.labelInterval = n
                    ? e.duration(n)
                    : this.computeLabelInterval(r));
        },
        computeLabelInterval: function (t) {
            var n, i, r;
            for (n = Oe.length - 1; n >= 0; n--)
                if (((i = e.duration(Oe[n])), (r = _(i, t)), ot(r) && r > 1))
                    return i;
            return e.duration(t);
        },
        computeEventTimeFormat: function () {
        ...
        renderDrag: function (t, e) {
            return e
                ? this.renderEventLocationHelper(t, e)
                : void this.renderHighlight(this.eventToSpan(t));
        },
        unrenderDrag: function () {
        ...
        renderSelection: function (t) {
            this.view.opt("selectHelper")
                ? this.renderEventLocationHelper(t)
                : this.renderHighlight(t);
        },
        unrenderSelection: function () {
            this.unrenderHelper(), this.unrenderHighlight();
    ...
    we.mixin({
        ...
        renderFgSegs: function (t) {
            return (
                (t = this.renderFgSegsIntoContainers(t, this.fgContainerEls)),
                (this.fgSegs = t),
                t
            );
        },
        ...
        renderHelperSegs: function (e, n) {
            var i,
                ...
                o = [];
            for (
                e = this.renderFgSegsIntoContainers(e, this.helperContainerEls),
                    i = 0;
                i < e.length;
                i++
            )
        ...
        renderFgSegsIntoContainers: function (t, e) {
            var n, i;
            for (
                t = this.renderFgSegEls(t), n = this.groupSegsByCol(t), i = 0;
                i < this.colCnt;
                i++
            )
            ...
            return (
                ...
                s.isMultiDayEvent(o)
                    ? (t.isStart || t.isEnd) &&
                      ...
                      (r = this.getEventTimeText(t, null, !1)))
                    : ((n = this.getEventTimeText(o)),
                      (i = this.getEventTimeText(o, "LT")),
                      (r = this.getEventTimeText(o, null, !1))),
                '<a class="' +
                    c.join(" ") +
                    '"' +
                    (o.url ? ' href="' + tt(o.url) + '"' : "") +
                    ...
                    (n
                        ...
                        : "") +
                    (o.title
                        ? '<div class="fc-title">' + tt(o.title) + "</div>"
                        : "") +
                    '</div><div class="fc-bg"/>' +
    ...
    var Ee = (qt.View = St.extend(ue, ce, {
            ...
            publiclyTrigger: function (t, e) {
                var n = this.calendar;
                return n.publiclyTrigger.apply(
                    n,
                    [t, e || this].concat(
            ...
            computeRange: function (t) {
                ...
                return (
                    /year|month|week|day/.test(i)
                        ...
                        : (r.hasTime() || (r = this.calendar.time(0)),
                          s.hasTime() || (s = this.calendar.time(0))),
                    (e = r.clone()),
            ...
            massageCurrentDate: function (t, e) {
                return (
                    this.intervalDuration.as("days") <= 1 &&
                        this.isHiddenDay(t) &&
                        ((t = this.skipHiddenDays(t, e)), t.startOf("day")),
                    t
                );
            },
            ...
            formatRange: function (t, e, n) {
                ...
                return (
                    ...
                    gt(t.start, i, e, n, this.opt("isRTL"))
                );
            },
            ...
            buildGotoAnchorHtml: function (e, n, i) {
                ...
                return (
                    t.isPlainObject(e)
                        ? ((r = e.date), (s = e.type), (o = e.forceOff))
                        : (r = e),
                    (r = qt.moment(r)),
            ...
            setDate: function (t) {
                ...
                (this.isDateSet = !0),
                    this.handleDate(t, e),
                    this.trigger(e ? "dateReset" : "dateSet", t);
            },
            unsetDate: function () {
                this.isDateSet &&
                    ((this.isDateSet = !1),
            ...
            unrenderNowIndicator: function () {},
            updateSize: function (t) {
                t && this.captureScroll(),
                    this.updateHeight(t),
                    this.updateWidth(t),
                    this.updateNowIndicator(),
                    t && this.releaseScroll();
            },
            ...
            captureInitialScroll: function (e) {
                this.captureScroll() &&
                    ((this.capturedScroll.isInitial = !0),
                    e
                        ? t.extend(this.capturedScroll, e)
                        : (this.capturedScroll.isComputed = !0));
            },
            releaseScroll: function () {
                var e = this.capturedScroll,
                    n = this.discardScroll();
                e.isComputed &&
                    (n ? t.extend(e, this.computeInitialScroll()) : (e = null)),
                    e &&
                        (e.isInitial
                            ? this.hardSetScroll(e)
                            : this.setScroll(e));
            },
            discardScroll: function () {
                return (
                    !--this.capturedScrollDepth &&
                    ((this.capturedScroll = null), !0)
                );
            },
            ...
            bindEvents: function () {
                ...
                this.isEventsBound ||
                    ...
                    this.rejectOn("eventsUnbind", this.requestEvents()).then(
                        function (e) {
                            t.listenTo(t.calendar, "eventsReset", t.setEvents),
                                t.setEvents(e);
                        }
                    ));
            },
            ...
            setEvents: function (t) {
                ...
                (this.isEventsSet = !0),
                    this.handleEvents(t, e),
                    this.trigger(e ? "eventsReset" : "eventsSet", t);
            },
            ...
            requestCurrentEventsRender: function () {
                return this.isEventsSet
                    ? void this.requestEventsRender(this.getCurrentEvents())
                    : bt.reject();
            },
                ...
                return (
                    ...
                    this.executeEventsUnrender().then(function () {
                        e.renderEvents(t),
                            e.thawHeight(),
                            e.releaseScroll(),
                            (e.isEventsRendered = !0),
                            e.onEventsRender(),
                            e.trigger("eventsRender");
                    })
                );
            },
            ...
            renderedEventSegEach: function (t, e) {
                var n,
                    i = this.getEventSegs();
                for (n = 0; n < i.length; n++)
                    (e && i[n].event._id !== e._id) ||
                        (i[n].el && t.call(this, i[n]));
            },
            getEventSegs: function () {
                return [];
            },
            ...
            isEventStartEditable: function (t) {
                return J(
                    t.startEditable,
                    (t.source || {}).startEditable,
                    this.opt("eventStartEditable"),
                    this.isEventGenerallyEditable(t)
                );
            },
            ...
            reportEventDrop: function (t, e, n, i, r) {
                ...
                this.triggerEventDrop(t, o.dateDelta, l, i, r),
                    s.reportEventChange();
            },
            ...
            reportExternalDrop: function (e, n, i, r, s) {
                ...
                a &&
                    ((o = t.extend({}, a, n)),
                    (l = this.calendar.renderEvent(o, e.stick)[0])),
                    this.triggerExternalDrop(l, n, i, r, s);
            },
            triggerExternalDrop: function (t, e, n, i, r) {
                this.publiclyTrigger("drop", n[0], e.start, i, r),
                    t && this.publiclyTrigger("eventReceive", null, t);
            },
            renderDrag: function (t, e) {},
            unrenderDrag: function () {},
            ...
            reportEventResize: function (t, e, n, i, r) {
                ...
                this.triggerEventResize(t, o.durationDelta, l, i, r),
                    s.reportEventChange();
            },
            ...
            triggerSelect: function (t, e) {
                this.publiclyTrigger(
                    "select",
                    null,
                    this.calendar.applyTimezone(t.start),
                    this.calendar.applyTimezone(t.end),
                    e
                );
            },
            unselect: function (t) {
            ...
            processEventUnselect: function (e) {
                this.selectedEvent &&
                    (t(e.target).closest(".fc-selected").length ||
                        this.unselectEvent());
            },
            ...
            initHiddenDays: function () {
                var e,
                    ...
                    r = 0;
                for (
                    this.opt("weekends") === !1 && n.push(0, 6), e = 0;
                    e < 7;
                    e++
                )
            ...
            computeDayRange: function (t) {
                ...
                return (
                    i &&
                        ((r = i.clone().stripTime()),
                        (e = +i.time()),
                        e && e >= this.nextDayThreshold && r.add(1, "days")),
        ...
        getUnitViewSpec: function (e) {
            ...
            if (t.inArray(e, Kt) != -1)
                for (
                    ...
                    if (((r = this.getViewSpec(n[i])), r && r.singleUnit == e))
                        return r;
        },
    ...
    De.mixin(ue),
        De.mixin({
            ...
            registerOptionHandlerObj: function (t, e) {
                (this.optionHandlers[t] || (this.optionHandlers[t] = [])).push(
                    e
                );
            },
    ...
    qt.locale("en", De.englishDefaults),
        (qt.sourceNormalizers = []),
        (qt.sourceFetchers = []);
    ...
    (De.prototype.normalizeEvent = function (t) {}),
        ...
        (De.prototype.isEventSpanAllowed = function (t, e) {
            ...
            return (
                this.isSpanAllowed(t, i, r, e) &&
                (!this.options.eventAllow ||
                    this.options.eventAllow(t, e) !== !1)
            );
        }),
        (De.prototype.isExternalSpanAllowed = function (e, n, i) {
            ...
            return (
                i &&
                    ((r = t.extend({}, i, n)),
                    (s = this.expandEvent(this.buildEventFromInput(r))[0])),
                s
                    ? this.isEventSpanAllowed(e, s)
                    : this.isSelectionSpanAllowed(e)
            );
        }),
        ...
        (De.prototype.isSpanAllowed = function (t, e, n, i) {
            ...
            for (o = this.getPeerEvents(t, i), l = 0; l < o.length; l++)
                if (((a = o[l]), this.eventIntersectsRange(a, t))) {
                    ...
                    if (i) {
                        if (
                            ((u = J(a.overlap, (a.source || {}).overlap)),
                            u === !1)
                        )
                            return !1;
    ...
    var Le = (qt.BasicView = Ee.extend({
            ...
            updateWidth: function () {
                this.colWeekNumbersVisible &&
                    (this.weekNumberWidth = u(this.el.find(".fc-week-number")));
            },
            setHeight: function (t, e) {
                var n,
                    s,
    ...
    var ze = (qt.AgendaView = Ee.extend({
                ...
                this.el.find(".fc-body > tr > td").append(e),
                    ...
                    this.dayGrid &&
                        ...
                        (this.dayGrid.bottomCoordPadding = this.dayGrid.el
                            .next("hr")
                            .outerHeight())),
                    (this.noScrollRowEls = this.el.find(
            ...
            updateSize: function (t) {
                this.timeGrid.updateSize(t),
                    Ee.prototype.updateSize.call(this, t);
            },
            updateWidth: function () {
            ...
            setHeight: function (t, e) {
                ...
                this.bottomRuleEl.hide(),
                    ...
                    e ||
                        ...
                        (o.left || o.right) &&
                            (i(this.noScrollRowEls, o),
                            (s = this.computeScrollerHeight(t)),
                            this.scroller.setHeight(s)),
                        this.scroller.lockOverflow(o),
                        this.timeGrid.getTotalSlatHeight() < s &&
            ...
            queryHit: function (t, e) {
                ...
                return (
                    !n && this.dayGrid && (n = this.dayGrid.queryHit(t, e)), n
                );
            },
            getHitSpan: function (t) {
            ...
            renderEvents: function (t) {
                ...
                (e = this.timeGrid.renderEvents(r)),
                    this.dayGrid && (s = this.dayGrid.renderEvents(i)),
                    this.updateHeight();
            },
            getEventSegs: function () {
        ...
        Ve = me.extend({
                ...
                for (
                    ...
                    if (
                        ...
                        e &&
                            !e.isEnd &&
                            t.end.hasTime() &&
                            t.end < i.clone().add(this.view.nextDayThreshold))
                    ) {
            ...
            handleSegClick: function (e, n) {
                ...
                me.prototype.handleSegClick.apply(this, arguments),
                    t(n.target).closest("a[href]").length ||
                        ((i = e.event.url),
                        i &&
                ...
                for (n = 0; n < s.length; n++)
                    if ((i = s[n]))
                        for (
                            l.append(
                                this.dayHeaderHtml(
                                    this.view.start.clone().add(n, "days")
                                )
                            ),
