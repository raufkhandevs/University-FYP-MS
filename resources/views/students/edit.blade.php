                                ...
                                <div id="step-1">
                                    ...
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="phone" value="{{ $student->user->phone }}"
                                ...
                                <div id="step-2">
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="number" value="{{ $student->semester }}" id="semester"
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <div id="alimni" class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-secondary" data-toggle-class="btn-primary"
                                                        data-toggle-passive-class="btn-secondary">
                                                        <input type="radio"
                                                            {{ $student->is_alumni == '1' ? 'checked' : '' }}
                                                            name="is_alumni" value="1" class="join-btn"> &nbsp; Yes
                                                        &nbsp;
                                                    </label>
                                                    <label class="btn btn-primary" data-toggle-class="btn-primary"
                                                        data-toggle-passive-class="btn-secondary">
                                                        <input type="radio"
                                                            {{ $student->is_alumni == '0' ? 'checked' : '' }}
                                                            name="is_alumni" value="0" class="join-btn"> No
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="credit_hours" value="{{ $student->credit_hours }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="quality_points" value="{{ $student->quality_points }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="cgpa" value="{{ $student->cgpa }}" class=" form-control"
                                                    name="cgpa" type="text">
                                            </div>
                                        </div>
