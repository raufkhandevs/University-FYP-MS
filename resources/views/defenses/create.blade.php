    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    <form action="{{ route('faculty.defenses.store') }}" method="POST">
                        ...
                        <div class="x_content d-flex justify-content-center" style="min-height: 300px">
                            ...
                            <div class="w-50">
                                ...
                                <div class="d-flex justify-content-center col-md-12 col-sm-12">
                                    <button type="submit" class=" text-center btn btn-primary d-block w-50">Create</button>
                                </div>
                            </div>
