...
@section('meta', 'Defense Type Edit')
    ...
    <div class="">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0" style="background: none">
                ...
                <li class="breadcrumb-item"><a href="{{ route('faculty.defense-types.index') }}">Defense</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    <form action="{{ route('faculty.defense-types.update', $defenseType->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="x_title">
                            <h2>Edit Defense Type </h2>
                        ...
                        <div class="x_content d-flex justify-content-center" style="min-height: 300px">
                            ...
                            <div class="w-50">
                                ...
                                <div class="col-md-12 col-sm-12 form-group has-feedback">
                                    <input type="text" value="{{ $defenseType->name }}" required name="name"
                                ...
                                <div class="col-md-12 col-sm-12 form-group has-feedback">
                                    <textarea name="about" id="" class="form-control " placeholder="About Defense Type ..." cols="30"
                                        rows="10">{{ $defenseType->about }}</textarea>
                                    @error('about')
                                        <div class="mt-1">
                                            <span class="text-danger">{{ $message }}</span>
                                        </div>
