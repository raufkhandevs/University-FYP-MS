                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div id="" class="form_wizard wizard_horizontal p-4">
                            ...
                            <form action="{{ route('faculty.users.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div id="step-1">
                                    ...
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="designation" name="designation" required class=" form-control"
                                                    type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
